...
var _teerawat1992$relm$Store$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _teerawat1992$relm$Store$productPanel = function (product) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('col-sm-6 col-md-4')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('thumbnail')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$src(product.image_url),
								_elm_lang$html$Html_Attributes$width(128),
								_elm_lang$html$Html_Attributes$height(128)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('caption')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(product.title)
									])),
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(product.description)
									])),
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										A2(_elm_lang$core$Basics_ops['++'], '$', product.price))
									]))
							]))
					]))
			]));
};
var _teerawat1992$relm$Store$view = function (products) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, _teerawat1992$relm$Store$productPanel, products));
};
var _teerawat1992$relm$Store$Product = F6(
...
var _teerawat1992$relm$Store$decodeProducts = _elm_lang$core$Json_Decode$list(_teerawat1992$relm$Store$decodeProduct);
var _teerawat1992$relm$Store$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _teerawat1992$relm$Store$FetchSucceed = function (a) {
	return {ctor: 'FetchSucceed', _0: a};
};
var _teerawat1992$relm$Store$getProducts = function () {
	var url = '/products.json';
	return A3(
		_elm_lang$core$Task$perform,
		_teerawat1992$relm$Store$FetchFail,
		_teerawat1992$relm$Store$FetchSucceed,
		A2(_evancz$elm_http$Http$get, _teerawat1992$relm$Store$decodeProducts, url));
}();
var _teerawat1992$relm$Store$init = {
	ctor: '_Tuple2',
	_0: _elm_lang$core$Native_List.fromArray(
		[
			A6(_teerawat1992$relm$Store$Product, '', '', '', '', '', '')
...
var Elm = {};
Elm['Store'] = Elm['Store'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Store'], 'Store', typeof _teerawat1992$relm$Store$main === 'undefined' ? null : _teerawat1992$relm$Store$main);
